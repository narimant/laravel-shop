...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('category')->group(function () {
            ...
            Route::get('/edit/{postCategory}', [CategoryController::class, 'edit'])->name('admin.market.category.edit');
            Route::put('/update/{postCategory}', [CategoryController::class, 'update'])->name('admin.market.category.update');
            Route::delete('/destroy/{postCategory}', [CategoryController::class, 'destroy'])->name('admin.market.category.destroy');
        });
